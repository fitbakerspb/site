...
function setMinData () {
  ...
  function listenerInputChange() {
    ...
    // Получаем все поля input для ввода информации о заказе
    const inputName = document.querySelectorAll(`input`);
    // Получаем поле Дополнительные пожелания к заказу
